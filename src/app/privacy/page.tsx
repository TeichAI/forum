...
export const metadata: Metadata = {
  ...
  description: "How Teich Forum collects, uses, discloses, retains, and protects personal information.",
};
...
const sections: LegalSection[] = [
  ...
  },
  {
    ...
    content: <>
      ...
      <p><strong>Teich Mail</strong> is not end-to-end encrypted. Direct Mail is visible to its thread participants, and Staff BCC sends independent one-to-one threads whose recipients do not see one another. A conversation addressed to the shared Staff Mailbox is visible to every current moderator and administrator, including staff promoted after it was sent; people who leave those roles lose access. Staff replies show the identity of the moderator or administrator who wrote them. Authorized staff may also access limited context around a Mail entry when it is reported, reasonably needed for safety, abuse prevention, support, or system integrity, or required by law. Recipients can save or share Mail, so do not treat it as a secure channel.</p>
  ...
  },
  {
    ...
    content: <>
      ...
      <ul>
        ...
        <li><strong>Teich Mail</strong> may remain for direct thread participants, in the shared Staff Mailbox, and for safety, integrity, and legal purposes after account deletion. Removing a personal mailbox copy does not recall another participant’s copy, and shared Staff Mailbox state is managed for the staff team.</li>
