...
const copy = { REPLY: "replied to your discussion", MENTION: "mentioned you", UPVOTE: "upvoted your post", FOLLOW: "started following you", MODERATION: "sent you a moderation update" } as const;
